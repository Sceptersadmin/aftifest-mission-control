...
export default async function DecisionCenterPage(){
  await requireOrganizationPermission("decision.read");
  return <FoundationPage active="Governance Room" eyebrow="Decision Center" title="Decisions with authority, context, and history." description="Proposals are organization-scoped and move through configurable approval chains. Role names alone never establish authority." columns={[
